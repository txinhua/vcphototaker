...
@protocol VCPTSliderDelegate;

typedef enum {
    VCPTSliderDirectionHorizonal  =   0,
    VCPTSliderDirectionVertical   =   1
} VCPTSliderDirection;

@interface VCPTSlider : UIControl
...
@property (nonatomic, assign) id <VCPTSliderDelegate> delegate;
...
@protocol VCPTSliderDelegate <NSObject>

@optional
- (void)didChangeValueSCSlider:(VCPTSlider*)slider value:(CGFloat)value;
- (void)didSCSliderTouchEnd:(VCPTSlider*)slider value:(CGFloat)value isTouch:(BOOL)isTouchEnd;
